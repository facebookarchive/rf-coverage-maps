...
declare module "@deck.gl/core/lib/layer" {
  ...
  declare export interface LayerContext {
  ...
  declare export interface BaseTransitionTiming {
  ...
  declare export interface LayerInputHandler<D = any> {
    (o: PickInfo<D>, e: HammerInput): any;
  }
  declare export type DataSet<D> = Iterable<D>;
  declare export interface LayerProps<D> {
    id?: string;
  ...
  declare export interface DefaultPropType {
    name: string;
    value: any;
    async?: boolean;
...
declare module "@deck.gl/core/lib/deck" {
  ...
  import type { TRANSITION_EVENTS } from "@deck.gl/core/controllers/transition-manager";

  declare export interface InteractiveState {
    isDragging: boolean;
  }
  declare export interface PickInfo<D> {
    layer: Layer<D>;
    index: number;
    object: D;
    x: number;
  ...
  declare export interface InitialViewStateProps {
    latitude?: number;
    longitude?: number;
    zoom?: number;
    bearing?: number;
...
declare module "@deck.gl/core/views/orbit-view" {
  ...
  declare export interface OrbitViewState {
    target: Position;
    rotationOrbit?: number;
    rotationX?: number;
    zoom?: number;
